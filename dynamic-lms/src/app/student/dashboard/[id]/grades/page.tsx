              ...
              return (
                <div key={category}>
                  ...
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <span className="rounded-full border border-black px-3 py-1 text-sm font-semibold text-gray-700">
                            ...
                            >
                              ...
                              {attempt.feedback && attempt.feedback.trim() && (
                                <div className="mt-2 rounded-xl border border-red-100 bg-white px-3 py-2 text-sm text-gray-700 min-w-0">
                                  <div className="text-xs font-semibold text-red-700 mb-1 break-words">Feedback</div>
                                  <div
