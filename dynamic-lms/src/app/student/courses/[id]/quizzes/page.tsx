                          ...
                          <div className="ml-4 flex flex-col sm:flex-row gap-2">
                            {quiz.taken && (
                              <button
                                ...
                                className="px-6 py-2 border border-red-600 text-red-600 rounded-lg font-semibold hover:bg-red-50 transform hover:-translate-y-0.5 transition-all duration-200"
                              >
                                View Results
                              </button>
                            )}
                            {isLocked ? (
                              ...
                              <Link
                                ...
                                className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 inline-block text-center"
                              >
