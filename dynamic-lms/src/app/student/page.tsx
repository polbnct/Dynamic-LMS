  ...
  return (
    <div className="min-h-screen bg-red-50">
      ...
      <nav className="bg-white border-b border-red-200 px-8 py-4 flex items-center justify-between shadow-sm">
        <span className="text-2xl font-bold text-red-600">Student LMS</span>
        <div className="flex gap-6 text-red-600 font-medium">
          <a href="#" className="hover:text-red-800">Dashboard</a>
          <a href="#" className="hover:text-red-800">My Courses</a>
          <a href="#" className="hover:text-red-800">Grades</a>
      ...
      <main className="flex items-start justify-center pt-12">
        <div className="w-full max-w-lg">
          <h1 className="text-2xl font-bold text-red-600 mb-6">My Course</h1>
          ...
          <div className="bg-white border border-red-200 rounded-2xl shadow-md p-6 mb-6">
            ...
            <p className="mt-2 text-red-500">Mathematical foundations for computer science, including logic, set theory, relations, combinatorics, and graph theory.</p>
            <button className="mt-4 px-6 py-2 rounded-lg bg-red-600 text-white font-bold hover:bg-red-700 transition">Go to Course</button>
          </div>
        </div>
      </main>
    </div>
