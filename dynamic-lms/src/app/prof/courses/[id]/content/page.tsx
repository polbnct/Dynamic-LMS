      ...
      {studyAidLesson && (
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-red-600 via-rose-600 to-red-700 px-4 sm:px-6 py-5 text-white">
              <div className="flex items-start sm:items-center justify-between gap-3">
                <div className="flex items-start sm:items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-red-100 text-sm mt-0.5 break-words">{studyAidLesson.title}</p>
                  </div>
                </div>
                <button
                  type="button"
